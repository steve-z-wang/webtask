...
def build_selector_prompt() -> str:
    ...
    who_you_are = (
        ...
        .add("You are an element selector that identifies which element on a web page matches a natural language description.")
    )
    ...
    how_to_select = (
        ...
        .add_numbered("Review the page context showing available elements with their element_ids")
        .add_numbered("Compare the user's description with each element's attributes and text")
    ...
    response_format = (
        ...
        .add_bullet("element_id: The ID of the matching element (e.g., 'button-0', 'input-1')")
